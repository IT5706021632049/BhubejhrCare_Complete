...
<body>
  <nav class="navbar navbar-light bg-light">
    <a class="navbar-brand" href="#">
      ...
      <b style="font-size:30px;">Appointment (DELETE)</b>
      <div align="right">
  ...
  <br>
  <input type="text" name="delete_appointment_id" class="form-control" style="width:30%;" placeholder="Appointment ID :"> <br>
...
$delete = "DELETE FROM appointment WHERE appoint_id = $delete_appointment_id";
